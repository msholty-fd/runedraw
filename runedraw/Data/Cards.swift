...
struct CardDatabase {
    ...
    private static func barbarianDeck() -> [Card] {
        unique([
            card("Strike",     "Deal 6 damage.",              cost: 1, type: .attack, class: .barbarian, effect: CardEffect(damage: 6)),
            card("Strike",     "Deal 6 damage.",              cost: 1, type: .attack, class: .barbarian, effect: CardEffect(damage: 6)),
            card("Strike",     "Deal 6 damage.",              cost: 1, type: .attack, class: .barbarian, effect: CardEffect(damage: 6)),
            card("Defend",     "Gain 5 block.",               cost: 1, type: .skill,  class: .barbarian, effect: CardEffect(block: 5)),
            card("Defend",     "Gain 5 block.",               cost: 1, type: .skill,  class: .barbarian, effect: CardEffect(block: 5)),
            card("Defend",     "Gain 5 block.",               cost: 1, type: .skill,  class: .barbarian, effect: CardEffect(block: 5)),
            card("Cleave",     "Deal 4 damage to ALL enemies.", cost: 1, type: .attack, class: .barbarian, effect: CardEffect(damage: 4, damageAllEnemies: true)),
    ...
    private static func rogueDeck() -> [Card] {
        unique([
            card("Backstab",     "Deal 8 damage.",                cost: 1, type: .attack, class: .rogue, effect: CardEffect(damage: 8)),
            card("Backstab",     "Deal 8 damage.",                cost: 1, type: .attack, class: .rogue, effect: CardEffect(damage: 8)),
            card("Backstab",     "Deal 8 damage.",                cost: 1, type: .attack, class: .rogue, effect: CardEffect(damage: 8)),
            card("Shadow Step",  "Gain 5 block. Draw 1.",         cost: 1, type: .skill,  class: .rogue, effect: CardEffect(block: 5, draw: 1)),
            card("Shadow Step",  "Gain 5 block. Draw 1.",         cost: 1, type: .skill,  class: .rogue, effect: CardEffect(block: 5, draw: 1)),
            card("Poison Blade", "Deal 4 damage. Apply 3 poison.", cost: 1, type: .attack, class: .rogue, effect: CardEffect(damage: 4, poisonStacks: 3)),
            card("Poison Blade", "Deal 4 damage. Apply 3 poison.", cost: 1, type: .attack, class: .rogue, effect: CardEffect(damage: 4, poisonStacks: 3)),
    ...
    private static func sorceressDeck() -> [Card] {
        unique([
            card("Fireball",     "Deal 12 damage.",                  cost: 2, type: .attack, class: .sorceress, effect: CardEffect(damage: 12)),
            card("Fireball",     "Deal 12 damage.",                  cost: 2, type: .attack, class: .sorceress, effect: CardEffect(damage: 12)),
            card("Magic Missile","Deal 6 damage.",                   cost: 1, type: .attack, class: .sorceress, effect: CardEffect(damage: 6)),
            card("Magic Missile","Deal 6 damage.",                   cost: 1, type: .attack, class: .sorceress, effect: CardEffect(damage: 6)),
            card("Magic Missile","Deal 6 damage.",                   cost: 1, type: .attack, class: .sorceress, effect: CardEffect(damage: 6)),
