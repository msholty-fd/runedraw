...
struct EncounterDatabase {
    ...
    static let all: [EncounterEvent] = [
        ...
        EncounterEvent(
            ...
            choices: [
                ...
                EncounterChoice("Smash It",
                                subtitle: "Take damage, but find something useful inside",
                                outcome: .combo([.damage(10), .loot(tier: 1)]),
                                isRisky: true),
                EncounterChoice("Leave It",
                                subtitle: "",
                                outcome: .nothing),
        ...
        EncounterEvent(
            ...
            choices: [
                EncounterChoice("Aid Them",
                                subtitle: "Treat their wounds — they share what they know",
                                outcome: .combo([.heal(3), .statPoints(1)])),
                EncounterChoice("Scavenge Their Gear",
                                subtitle: "Take what they won't be using",
                                outcome: .loot(tier: 1)),
        ...
        EncounterEvent(
            ...
            icon: "🛒",
            choices: [
                EncounterChoice("Browse Wares",
                                subtitle: "They offer a card in trade for a minor risk",
                                outcome: .chance(0.75, good: .loot(tier: 1), bad: .damage(8)),
                                isRisky: true),
                EncounterChoice("Ask About Rarer Stock",
                                subtitle: "Take more risk for better quality",
                                outcome: .chance(0.55, good: .loot(tier: 2), bad: .damage(15)),
                                isRisky: true),
        ...
        EncounterEvent(
            ...
            choices: [
                EncounterChoice("Offer Blood",
                                subtitle: "Spend 15% HP — receive power and loot",
                                outcome: .combo([.damagePercent(0.15), .loot(tier: 2)])),
        ...
        EncounterEvent(
            ...
            choices: [
                EncounterChoice("Approach",
                                ...
                                outcome: .chance(0.40,
                                                 good: .combo([.healPercent(0.15), .loot(tier: 1)]),
        ...
        EncounterEvent(
            ...
            choices: [
                ...
                EncounterChoice("Extract the Core",
                                subtitle: "Take damage but claim a valuable item",
                                outcome: .combo([.damage(12), .loot(tier: 2)])),
                EncounterChoice("Leave It",
                                subtitle: "",
                                outcome: .nothing),
            ],
        ...
        EncounterEvent(
            ...
            description: "A holy vessel now filled with brackish water. Something glitters at the bottom despite the filth.",
            icon: "⛪",
            choices: [
                EncounterChoice("Reach In",
                                subtitle: "Claim what's inside, accept the corruption",
                                outcome: .combo([.damagePercent(0.12), .loot(tier: 2)])),
        ...
        EncounterEvent(
            ...
            icon: "⚔️",
            choices: [
                EncounterChoice("Pay the Toll",
                                subtitle: "Take a hit to end things quickly — they throw in something extra",
                                outcome: .combo([.damage(8), .loot(tier: 2)])),
                EncounterChoice("Refuse and Fight",
                                subtitle: "They lash out before you're ready — you take a hit, but loot them after",
                                outcome: .combo([.damage(25), .loot(tier: 1)]),
                                isRisky: true),
